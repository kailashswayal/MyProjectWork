...
public class LoginPage {
	...
	/*
	 * // operations method public void sendUsername() { usn.sendKeys("admin"); }
	 * public void sendPassword() { psw.sendKeys("manager"); } public void
	 * clickOnLoginbutton() { loginbtn.click(); }
	 */
